...
//operator
    ...
    bool placeModules();
    float getLeftXOnAreaLimit(float high_y, float low_y);
    float getRightXOnAreaLimit(float high_y, float low_y);
    float getLeftXOnOutlineLimit(float high_y, float low_y);
    float getRightXOnOutlineLimit(float high_y, float low_y);
    float getTopYOnAreaLimit(float high_x, float low_x);
    float getBottomYOnAreaLimit(float high_x, float low_x);
    float getTopYOnOutlineLimit(float high_x, float low_x);
    float getBottomYOnOutlineLimit(float high_x, float low_x);
