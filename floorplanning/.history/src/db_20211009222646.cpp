...
void Module::cutIntoRect()
{
    ...
    case Shape::LSHAPE :
    {
        ...
        Point* left_up_right = new Point(lx_1, hy_1);
        sub_module_right->addBoundaryPoint(left_up_right);
        Point* left_low_right = new Point(lx_1, ly_1);
        sub_module_right->addBoundaryPoint(left_low_right);
        Point* right_low_right = new Point(hx_1, ly_1);
        sub_module_right->addBoundaryPoint(right_low_right);
        Point* right_up_right = new Point(hx_1, hy_1);
