...
float DataService::getLeftXOnAreaLimit(float high_y, float low_y)
{
    ...
    {
        float low_x, high_x;
        low_x  = pointNextToRange1->getX() <= pointNextToRange2->getX() ? pointNextToRange1->getX() : pointNextToRange2->getX();
        high_x = pointNextToRange1->getX() > pointNextToRange2->getX() ? pointNextToRange1->getX() : pointNextToRange2->getX();
        if(low_x == high_x)
        {
            return low_x;
        }
        ...
        {
            float low_y, high_y;
            low_y  = pointNextToRange1->getY() <= pointNextToRange2->getY() ? pointNextToRange1->getY() : pointNextToRange2->getY();
            high_y = pointNextToRange1->getY() > pointNextToRange2->getY() ? pointNextToRange1->getY() : pointNextToRange2->getY();
