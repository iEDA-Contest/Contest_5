...
float DataService::getLeftXOnAreaLimit(float low_y, float high_y)
{
    ...
    pointNextToRange2 = _area[size - 1];
    ...
    {
        float x1 = pointNextToRange1->getX();
        float x2 = pointNextToRange2->getX();
        ...
        {
            float y1 = pointNextToRange1->getY();
            float y2 = pointNextToRange2->getY();
